...
with app.app_context():
    ...
    users = [
        User(name="John Doe", email="john@electric.com", mobile="1234567890", username="john", password="john", role="professional", address="123 Main St", pin="123456", verified=True),
        User(name="Sarah Lee", email="sarah@cleanhome.com", mobile="9876543210", username="sarah_clean", password="hashed_password", role="professional", address="456 Elm St", pin="654321", verified=True),
